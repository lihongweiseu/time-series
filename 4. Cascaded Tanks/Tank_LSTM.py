...
for i in range(1,21):
    ...
    LSTM_model_m, loss_all, loss_m, cost_time, im, cost_time_str = LSTM_training(1, Nt, u[:,:1], LSTM_model, in_s, layer_s, hidden_s, N, y_ref[:,:1], device, bias_status)
