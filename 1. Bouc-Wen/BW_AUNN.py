...
for i in range(1,21):
    ...
    AUNN_model_m, loss_all, loss_m, cost_time, im, cost_time_str = AUNN_training(1, Nt1, u[:,:Nt1], AUNN_model, x_s, in_s, N, y_ref[:,:Nt1], non_layer_s, non_neuron, device, bias_status)
